...
export interface SearchTokenReadOnlyInterface {
  balance: ({
    address
  }: {
    address: string;
...
export class SearchTokenQueryContract extends Contract implements SearchTokenReadOnlyInterface {
...
export interface SearchTokenInterface extends SearchTokenReadOnlyInterface {
  transfer: ({
    account,
    customFees,
    memo,
...
export class SearchTokenContract extends SearchTokenQueryContract implements SearchTokenInterface {
