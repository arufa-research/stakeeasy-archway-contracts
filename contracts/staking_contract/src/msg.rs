...
pub enum ExecuteMsg {
    Stake { referral: u64 },
    StakeForbarch { referral: u64 },
    Claim {},
    ClaimAndStake {},

    UpdateSearchAddr { address: Addr },
    UpdateBarchAddr { address: Addr },
...
pub enum ReferralMsg {
    ...
    Withdraw { recipient: String, barch: bool, amount: Uint128 }
}
