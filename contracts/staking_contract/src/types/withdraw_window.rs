...
pub struct QueueWindow {
    pub id: u64,
    pub total_seArch: Uint128,
    pub total_barch: Uint128,
}
...
//         self.as_readonly().account_amount(&"total_arch".to_string())
//     }

//     pub fn set_total(&mut self, amount: u128) {
//         self.storage.set("total_arch".as_bytes(), &amount.to_be_bytes())
//     }
