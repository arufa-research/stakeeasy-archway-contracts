...
use cosmwasm_std::{
    to_binary, Binary, Deps, DepsMut, Env, MessageInfo, Response, StdError, StdResult, Uint128, CosmosMsg, WasmMsg,
};
...
pub fn instantiate(
    ...
    for row in msg.initial_balances {
        //***************************************************************
        let inc_balance_to_recipient = RewardContractResponseMsg::IncreaseBalance{
            address: row.address.to_string(),
            amount: row.amount
        };
        messages.push(CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: msg.reward_contract_addr.clone(),
            msg: to_binary(&inc_balance_to_recipient)?,
            funds: vec![],
        }));
        //***************************************************************
    }
     
    // keeping staking contract address in config***********
    let config = Config{ 
        reward_contract: msg.reward_contract_addr
    };
...
pub fn execute_transfer(
    ...
    let mut messages:Vec<CosmosMsg> = vec![];
    let decrease_balance_from_sender= RewardContractResponseMsg::DecreaseBalance{
        address: info.sender.to_string(),
        amount
    };
    messages.push(CosmosMsg::Wasm(WasmMsg::Execute {
        contract_addr: config.reward_contract.clone(),
        msg: to_binary(&decrease_balance_from_sender)?,
        funds: vec![],
    }));
    let inc_balance_to_recipient = RewardContractResponseMsg::IncreaseBalance{
...
pub fn execute_mint(
    ...
    messages.push(CosmosMsg::Wasm(WasmMsg::Execute {
        contract_addr: staking_config.reward_contract.clone(),
        msg: to_binary(&inc_balance_to_recipient)?,
        funds: vec![],
    }));
    //*************************************************************
...
mod tests {
    use cosmwasm_std::testing::{
        mock_dependencies, mock_dependencies_with_balance, mockenv, mock_info,
    };
    ...
    fn do_instantiate_with_minter(
        ...
        _do_instantiate(
            ...
            "arch13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string()
        )
    }

    // this will set up the instantiation for other tests
    fn do_instantiate(deps: DepsMut, addr: &str, amount: Uint128, staking_addr: String) -> TokenInfoResponse {
        _do_instantiate(deps, addr, amount, None, staking_addr)
    }
    ...
    fn _do_instantiate(
        ...
        let instantiate_msg = InstantiateMsg {
            ...
            mint: mint.clone(),
            marketing: None,
            reward_contract_addr: staking_addr.to_string()
        };
    ...
    mod instantiate {
        ...
        fn basic() {
            ...
            let instantiate_msg = InstantiateMsg {
                ...
                mint: None,
                marketing: None,
                reward_contract_addr: "arch13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string()
            };
            let info = mock_info("creator", &[]);
            let env = mockenv();
    ...
    fn no_one_mints_if_minter_unset() {
        let mut deps = mock_dependencies();
        do_instantiate(deps.as_mut(), &String::from("genesis"), Uint128::new(1234),"arch13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string());
    ...
    fn queries_work() {
        ...
        let expected = do_instantiate(deps.as_mut(), &addr1, amount1,"arch13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string());
    ...
    fn transfer() {
        ...
        do_instantiate(deps.as_mut(), &addr1, amount1,"arch13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string());
    ...
    mod marketing {
        ...
        fn update_unauthorised() {
            ...
            instantiate(deps.as_mut(), mockenv(), info.clone(), instantiate_msg).unwrap();
